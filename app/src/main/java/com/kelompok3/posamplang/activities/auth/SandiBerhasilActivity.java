...
public class SandiBerhasilActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLoginSekarang.setOnClickListener(v -> {
            // Kembali ke halaman login utama dan hapus semua history activity sebelumnya
            Intent intent = new Intent(SandiBerhasilActivity.this, LoginActivity.class);
