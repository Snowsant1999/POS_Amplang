...
@Entity(
    tableName = "pembayaran_pesanan",
    foreignKeys = @ForeignKey(
        entity = Pesanan.class,
        parentColumns = "id_pesanan",
        childColumns = "id_pesanan",
        onDelete = ForeignKey.CASCADE
    ),
    indices = {@Index("id_pesanan")}
)
public class PembayaranPesanan {
    ...
    private long tanggal_pembayaran; // timestamp
    private double total_pembayaran;
    private double total_kembalian;

    public PembayaranPesanan(int id_pesanan, String metode_pembayaran, String status_pembayaran, long tanggal_pembayaran, double total_pembayaran, double total_kembalian) {
    ...
    public long getTanggal_pembayaran() { return tanggal_pembayaran; }
    public void setTanggal_pembayaran(long tanggal_pembayaran) { this.tanggal_pembayaran = tanggal_pembayaran; }
